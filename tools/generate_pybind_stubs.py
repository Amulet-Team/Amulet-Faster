...
def main() -> None:
    ...
    amulet_faster_path = get_package_dir("amulet.faster")
    tests_path = os.path.join(root_path, "tests")
    test_amulet_faster_path = os.path.join(tests_path, "test_amulet_faster")
    ...
    modules: list[tuple[str, str, str]] = [
        (src_path, amulet_faster_path, "amulet.faster"),
        (tests_path, test_amulet_faster_path, "test_amulet_faster"),
    ]
